...
class AsyncConfigTest {
    ...
    void getAsyncUncaughtExceptionHandler_shouldHandle() throws Exception {
        ...
        Method method = AsyncConfigTest.class.getDeclaredMethod("getAsyncExecutor_shouldReturnInjectedExecutor");
        handler.handleUncaughtException(new RuntimeException("error"), method, new Object[0]);
        // 没有抛出异常即视为通过
    }
}
